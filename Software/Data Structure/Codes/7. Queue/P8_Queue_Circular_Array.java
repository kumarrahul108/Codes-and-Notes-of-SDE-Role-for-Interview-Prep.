...
// *** Circular Quueu Using Arrays from Scratch ***


public class P8_Queue_Circular_Array 
{
    static int arr[];
    static int size ;
    static int f = -1;            
    ...
    P8_Queue_Circular_Array(int size) 
    {
        this.size = size;
        arr = new int[size]; 
    }   
    ...
    {
        P8_Queue_Circular_Array l3 = new P8_Queue_Circular_Array(10);
